...
function Projectitem({title,backgroundImg,projectUrl,platform}) {
  return (
    <div>
        <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-300 roundeed-xl p-1 group hover:bg-gradient-to-r from-[#5651e5] to-[#709dff] '>
